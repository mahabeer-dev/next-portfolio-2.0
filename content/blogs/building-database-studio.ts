...
const post: BlogPost = {
  ...
  title:
    "Building Database Studio — A Full-Stack Database Viewer from Scratch",
  excerpt:
  ...
  platform: "personal",
  coverImage: "https://picsum.photos/seed/dbstudio-cover/1200/630",
  content: [
    {
      type: "paragraph",
    ...
    {
      type: "image",
      src: "https://picsum.photos/seed/dbstudio-problem/1200/675",
      alt: "Comparison of multiple database GUI tools on a developer desktop",
      caption: "The problem — too many tools for too many databases",
    },
    {
      type: "heading",
  ...
  getTableData(table: string, page: number, limit: number): Promise<Row[]>
    ...
    {
      type: "image",
      src: "https://picsum.photos/seed/dbstudio-arch/1200/675",
      alt: "Database Studio architecture diagram showing client, server, and database layers",
      caption: "High-level architecture — React SPA, Express API, and database drivers",
    },
    {
      type: "heading",
    ...
    {
      type: "image",
      src: "https://picsum.photos/seed/dbstudio-schema/1200/675",
      alt: "Database Studio schema visualizer showing interactive table cards in a grid layout",
      caption: "Schema View — interactive cards with field types and relationships",
    },
    {
      type: "heading",
