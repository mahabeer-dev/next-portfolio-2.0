...
const post: BlogPost = {
  ...
  content: [
    ...
    {
      type: "paragraph",
      text: "Before you begin, make sure you have an active Apple Developer Program membership ($99/year). You'll also need the Account Holder or Admin role in your developer team — only these roles have permission to create APNs keys. If you're on a free developer account, push notifications are not available.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Navigate to the Apple Developer Account page at developer.apple.com/account and sign in with your Apple ID. Once logged in, you'll see the developer dashboard with various sections like Certificates, Identifiers, Profiles, and Keys.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: 'If you\'re using Firebase Cloud Messaging, head to the Firebase Console → Project Settings → Cloud Messaging tab. Under the "Apple app configuration" section, click "Upload" next to APNs Authentication Key. Upload your .p8 file and enter the Key ID and Team ID you noted earlier.',
    },
    {
      type: "code",
      language: "text",
