...
import { blogs, BLOGS_PER_PAGE, blogListUrl } from "@/lib/blogs";
import {
  ArrowRight,
  Calendar,
  Clock,
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-5">
          {visibleBlogs.map((blog, index) => (
            <motion.a
              ...
              className="group rounded-2xl border bg-gradient-to-br from-orange-600/5 to-rose-600/5 p-5 sm:p-6 flex flex-col justify-between cursor-pointer"
            >
              <div>
