...
export default function Projects() {
  ...
  return (
    <section id="projects" className="bg-muted/40 py-12 sm:py-16 md:py-20 overflow-hidden">
      <div className="container px-4 md:px-6">
        ...
        <StaggerChildren className="mt-8 sm:mt-12 grid gap-4 sm:gap-6 md:gap-8 md:grid-cols-2" initialDelay={0.2}>
            ...
            <StaggerItem key={index} direction="up">
              <Card className="overflow-hidden h-full transition-all duration-300 hover:shadow-md hover:-translate-y-1">
                ...
                <CardContent className="p-4 sm:p-6">
                  <h3 className="mb-1 sm:mb-2 text-lg sm:text-2xl font-bold">{project.title}</h3>
                  <p className="mb-3 sm:mb-4 text-xs sm:text-sm text-muted-foreground">{project.description}</p>
        ...
        <FadeIn direction="up" delay={0.6} className="mt-8 sm:mt-12 flex justify-center">
